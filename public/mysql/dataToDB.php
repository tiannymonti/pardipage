...
$pf_med1 = htmlspecialchars($_GET["pf"]);
$vbatt1 = htmlspecialchars($_GET["vbatt1"]);
$vbatt2 = htmlspecialchars($_GET["vbatt2"]);
//call wunder
wunder();
...
if ($timestamp == 0) {
	...
	$query .= "INSERT INTO `metcentraldata` (`id`, `date_time`, `temperature`, `humidity`, `wind_speed`, `voltage_med1`, `curr_med1`, `energy_med1`, `power_med1`, `latitude`, `longitude`,`pf_med1`,`vbatt1`,`vbatt2`) VALUES (NULL, NOW(), '$temperature', '$humidity', '1', '$voltage_med1', '$current_med1', '$energy_med1', '$power_med1', '$latitude', '$longitude','$pf_med1','$vbatt1','$vbatt2');";
...
else
{
	...
	"INSERT INTO `metcentraldata` (`id`, `date_time`, `temperature`, `humidity`, `wind_speed`, `voltage_med1`, `curr_med1`, `energy_med1`, `power_med1`, `latitude`, `longitude`,`pf_med1`,`vbatt1`,`vbatt2`) VALUES (NULL, '$date_time', '$temperature', '$humidity', '1', '$voltage_med1', '$current_med1', '$energy_med1', '$power_med1', '$latitude', '$longitude','$pf_med1','$vbatt1','$vbatt2');");
}
