...
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <!-- Show Mean Peak Sun-Hours
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count pull-right" style="padding-bottom: 0px; padding-left: 1%">
              ...
              <div id="dev_energy" class="count" style="text-align:center"></div>
        ...
        <footer>
          <div class="pull-right">
            © Copyright 2016, Power Tracking Services
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script>
      ...
      function auto_loadcont(variable){
        $.ajax({
          ...
          success: function(data) {
            ...
            if (variable == "inv_xantrex"){
              $.ajax({
                url: "/mysql/centraldata.php",
                method: "POST",
                data: {
                  variable: "voltage_med1",
                  origin: window.location.pathname
                },
                cache: false,
      ...
      function ShowControl(){
        auto_loadcont("inv_xantrex");
        auto_loadcont("batt1");
        auto_loadcont("batt2");
      }

      function ShowXantrex(){
        $.ajax({
          url: "/mysql/loadcontrol.php",
          method: "POST",
          data: {
            variable: "inv_xantrex",
            origin: window.location.pathname
          },
          cache: false,
          success: function(data) {
