          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Vibrational Analysis <small>Filter Results</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="ID" id="ids"> ID
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Eje X" id="xaxis">  Eje X
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Eje Y" id="yaxis"> Eje Y
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Eje Z" id="zaxis"> Eje Z
                        </label>
                      </div>
                    </div>
