                    ...
                    <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                      <li>
                        <div class="text-center">
                          <a>
                            <strong>There Is No Alerts..</strong>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count" style="margin-bottom: 0px;">
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count pull-right">
              ...
              <div class="count"><p id="intemperature"></p></div>                  <!-- Aca esta lode intemp-->
              <span class="count_bottom">Last Time Measured:</br><span id="date_time2"></span></span>
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count pull-right">
              <span class="count_top"><i class="wi wi-humidity"></i> Internal Humidity</span>
              <div class="count"><p id="inhumidity"></p></div>                     <!-- Aca esta lode intemp-->
              <span class="count_bottom">Last Time Measured:</br><span id="date_time"></span> </span>
            </div>
          </div>
          <!-- /top tiles -->
              ...
              $.ajax({
                ...
                success: function(data) {
                  if (variable == "gauge-text") {
                    ...
                    if (variable=="date_time"){  //Para colocar las dos fechas en intemperature y inhumiditu
                        var element = "#".concat(variable);
                        document.getElementById(variable).innerHTML = append_element;     // para inhum date_time
                        var element = "#".concat(variable+"2");
                        document.getElementById(variable+"2").innerHTML = append_element; // para intemp date_time2
                    }
                    else{
                        var element = "#".concat(variable); // para las otras variables queda igual
