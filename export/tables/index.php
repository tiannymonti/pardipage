                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Temperature [°C]" id="temperature">  Temperature
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Voltage (M.1) [V] " id="voltage_med1"> Voltage (Meter 1)
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Current (M.1) [A]" id="curr_med1"> Current (Meter 1)
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Energy (M.1) [kWh]" id="energy_med1"> Energy (Meter 1)
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Power (M.1) [W]" id="power_med1"> Power (Meter 1)
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Vbatt1 [V]" id="vbatt1"> Vbatt1
                        </label>
                      </div>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" class="flat" name="toShow" value="Vbatt2 [V]" id="vbatt2"> Vbatt2
                        </label>
                      </div>
                    </div>
